...
def dryad():
    filenames = ['kongsfjorden_spames','loughhyne_spnames','stmarks_spnames','weddell_spnames','ythan_spnames']
...
def plantPollinator():
    ...
    dct['encoding']['path'] = "C:/Users/davie/Desktop/Masters/Dissertation/Code/DissertationCode/Eigg/Utilities/RelevantDatasets/production/validation/plantPollinator.csv"
...
def dryadValidation():
    ...
    dct['encoding']['dataCorner'] = '(2,2)'
    dct['encoding']['nameDepth'] = 1
    dct['encoding']['path'] = "C:/Users/davie/Desktop/Masters/Dissertation/Code/DissertationCode/Eigg/Utilities/RelevantDatasets/production/validation/reef_spnames.xls"
    return [dct]
...
def nzOne():
    ...
    dct['encoding']['dataCorner'] = '(2,2)'
    dct['encoding']['nameDepth'] = 1
    dct['encoding']['path'] = "C:/Users/davie/Desktop/Masters/Dissertation/Code/DissertationCode/Eigg/Utilities/RelevantDatasets/production/validation/Kyeburn.xls"
    return [dct] 
...
def nzTwo():
    ...
    dct['encoding']['dataCorner'] = '(2,2)'
    dct['encoding']['nameDepth'] = 1
    dct['encoding']['path'] = "C:/Users/davie/Desktop/Masters/Dissertation/Code/DissertationCode/Eigg/Utilities/RelevantDatasets/production/validation/Coweeta17.xls"
    return [dct]